...
std::map<int, std::vector<float>> step{
  ...
  {26,  {400,500,0,100,   -200,-35,     0,    -2,0,1,1}},   // berotasi menyesuaikan ke SZ2
  {27,  {220,0,0,0,       -200,-200,    0,    -2,0,1,1}},   // maju menyesuaikan ke SZ2
  {28,  {240,400,0,270,   -200,-200,    0,    -2,0,1,1}},   // menyamping menyesuaikan ke SZ2
...
std::map<int, std::vector<bool>> _f_{
  ...
  {27,  {1,0,0,0,0,0,0, 1,0,1}},
  {28,  {0,1,0,0,0,0,0, 1,0,1}},
